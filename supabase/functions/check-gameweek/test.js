...
// Function to get dates friday to monday
...
(async () => {
  ...
  if (!gameWeekInfo[0].activeWeek) {
    console.log("No active week found.");
    return;
  } else {
    console.log("Active week found.");
  }
  ...
  // if (!gameWeekInfo || gameWeekInfo.length === 0 || !gameWeekInfo[0].activeWeek) {
  //   console.log("No active week found.");
  //   return;
  // }
  await isEnoughGames();
